...
class HWWAnalysis(Analysis.Analysis):
  ...
  def analyze(self):
      ...
      if (abs(leadLepton.pdgId()) == abs(trailLepton.pdgId())):
          ...
          if not abs(mll - Constants.Z_Mass) > -999: return False # TO DO: Find a good value for this cut
          if not etmiss.et() > -999: return False # TO DO: Find a good value for this cut
      else:
      ...
      if not combTLV.M() < -999: return False # TO DO: Find a good value for this cut
